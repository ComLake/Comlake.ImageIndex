...
public class KMeans {
    ...
    public static final void Readdata() throws IOException {
        String filePath = "C:\\Users\\Thong\\Comlake.ImageIndex\\MyFile.csv";
    ...
    public static Double CalculateCentroid() {
        ...
        try {
            output = new FileWriter("C:\\Users\\Thong\\Comlake.ImageIndex\\Clusters.csv", Charset.forName("UTF8"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        for (int i = 0; i < Clusters.size(); i++) {
            ...
            try {
                output.write("Centroid of Cluster: "+i + ","+ points.getX() + "," + points.getY() + "\n");
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    public static void Clustering() {
        FileWriter output = null;
        try {
            output = new FileWriter("C:\\Users\\Thong\\Comlake.ImageIndex\\Points and Clusters.csv", Charset.forName("UTF8"));
        } catch (IOException e) {
            e.printStackTrace();
        }
